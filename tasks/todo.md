...
- [x] Pestaña **Proveedores**, separada en Global y Cliente: la tabla de bancos y conectores con la salud de
      sus empresas, y la ficha de los proveedores de una empresa concreta con las demás empresas de cada banco
      (`pipeline/src/providers.py` → `providers.json`, `frontend/src/providers/`, velocímetro en `shared/Gauge.tsx`).
